...
try {
  ...
  $stmt = $dbcon->prepare("SELECT * FROM main_data WHERE context = 'ACTIVE_ANGGARAN_PENDAPATAN' AND integer_b = 2020 AND flag_a = 1 ORDER BY text_a,text_b,text_c,text_d,text_e");
  if ($stmt->execute()) {
